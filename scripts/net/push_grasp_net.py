...
class push_grasp_net(nn.Module):
    ...
    def __init__(self, use_cuda = True): # , snapshot=None
        ...
        self.push_color_trunk = torchvision.models.densenet.densenet121(pretrained=True, memory_efficient = True)
        self.push_depth_trunk = torchvision.models.densenet.densenet121(pretrained=True, memory_efficient = True)
        self.grasp_color_trunk = torchvision.models.densenet.densenet121(pretrained=True, memory_efficient = True)
        self.grasp_depth_trunk = torchvision.models.densenet.densenet121(pretrained=True, memory_efficient = True)
